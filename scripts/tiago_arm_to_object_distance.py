...
However, if the object is not oriented correctly, the Aruco marker cannot be detected, and the robot determines that the object is not in the grasping pose.
